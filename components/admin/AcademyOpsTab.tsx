...
interface AcademyStats {
    ...
    retentionProxy: number | null; // 2회 이상 평가 완료 학생 비율 (재등록 프록시)
    ...
    return (
        <div className="animate-fade-in space-y-8">
            ...
            <p className="text-sm text-gray-400 -mt-4">
                * 재등록률·교사 품질을 직접 집계하는 구독/평가 데이터가 아직 없어, 현재는 <b>다회 평가 완료 비율</b>(재등록 프록시)과 <b>집중 케어 필요 비율</b>(코칭 부담 프록시)로 대체 표기합니다.
            </p>
